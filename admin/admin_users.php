              ...
              ?>
                  ...
                  <td><?=$i?></td>
                    ...
                    <td>
                      ...
                      <li><a href="admin_edituser.php?id=<?=$r["mauser"]?>" title="Edit" class="edit" itemprop="<?=$r["mauser"]?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li> -->
                      <li><a href="" title="Delete" class="remove" itemprop="<?=$r["mauser"]?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a></li>
                    </td>
                  </tr>
              <?php
              $i++;
